...
?>
<!-- ----------------------------------------------------- -->
<!-- if user is already logged in then no need to login and if user press back then he will move completely back to previous page or redirected to home page  -->
<?php 
...
<img style="height:auto; width:20%; margin-left:40%; margin-top:5%;" src="../image/spanlogo.png" alt="">
   ...
   if(isset($_SESSION['wrong']))
   {
     ?>
               ...
               <p class="text-white"><?php echo  $_SESSION['wrong']; ?></p> 
   ...
   unset($_SESSION['wrong']);
     ...
     ?>
      <form action="validation.php" method="post" class="form form-login">
        <div class="form-field">
          <label class="user" for="login-username"><span class="hidden">Username</span></label>
          <input name="user" id="login-username" type="text" class="form-input" placeholder="Username" required>
        </div>
